module github.com/quantcdn/pulumi-quant/provider
...
require (
	...
	github.com/quantcdn/terraform-provider-quant/v5 v5.2.0
)
...
require (
	...
	github.com/quantcdn/quant-admin-go/v4 v4.15.3 // indirect
