...
namespace QuantCDN.Quant
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/quantcdn/pulumi-quant";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("QuantCDN.Quant.version.txt");
    ...
    internal sealed class QuantResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public QuantResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
