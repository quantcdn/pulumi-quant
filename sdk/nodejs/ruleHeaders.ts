...
export class RuleHeaders extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RuleHeadersState, opts?: pulumi.CustomResourceOptions): RuleHeaders {
        return new RuleHeaders(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'quant:index:RuleHeaders';

    /**
     * Returns true if the given object is an instance of RuleHeaders.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RuleHeaders {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RuleHeaders.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: RuleHeadersArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RuleHeadersArgs | RuleHeadersState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as RuleHeadersArgs | undefined;
        ...
        super(RuleHeaders.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RuleHeadersState {
    /**
     * Rule action
     */
